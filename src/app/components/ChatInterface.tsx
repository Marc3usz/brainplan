...
export function ChatInterface() {
  ...
  {/* Zielony przycisk Share Google Calendar */}
  <button
    onClick={handleShareCalendar}
    disabled={isSharing}
    className="px-6 py-3 bg-green-600 text-white rounded-md hover:bg-green-700 disabled:bg-gray-600 disabled:cursor-not-allowed transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 focus:ring-offset-gray-900 w-full max-w-xs self-center"
  >
    {isSharing ? (
      <>
